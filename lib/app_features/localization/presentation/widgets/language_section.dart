...
class _LanguageSectionState extends State<LanguageSection> {
  ...
  void submitLang(BuildContext context, String lang) {
    sl<CashHelper>().saveData(key: 'changeLang', value: true).then((value) {
      print('changeLang saved: true');
      sl<CashHelper>().saveData(key: 'lanSelected', value: true);
      print('lanSelected saved: true');
    });
